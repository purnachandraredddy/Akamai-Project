...
class MetricsCollector:
    ...
    def record_character_processed(
        self, status: str, species: str, origin_type: str
    ):
        """Record character processing metrics"""
        CHARACTERS_PROCESSED.labels(
            status=status, species=species, origin_type=origin_type
        ).inc()
    ...
    def record_external_api_call(
        self, api_name: str, status: str, duration: float
    ):
