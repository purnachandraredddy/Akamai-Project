...
from sqlalchemy import String, Integer, DateTime, Text, JSON, Boolean, Index, UniqueConstraint, CheckConstraint
...
class Character(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status IN ('Alive', 'Dead', 'unknown')", name='ck_character_status'),
        CheckConstraint("gender IN ('Male', 'Female', 'Genderless', 'unknown')", name='ck_character_gender'),
        CheckConstraint("species IS NOT NULL AND species != ''", name='ck_character_species_not_empty'),
        CheckConstraint("name IS NOT NULL AND name != ''", name='ck_character_name_not_empty'),
...
class CacheEntry(Base):
    ...
    __table_args__ = (
        # Check constraints for data validation
        CheckConstraint("key IS NOT NULL AND key != ''", name='ck_cache_key_not_empty'),
