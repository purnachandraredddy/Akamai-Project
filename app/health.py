...
class CircuitBreaker:
    ...
    async def _handle_failure(self, error: str):
        ...
        if self.metrics.failure_count >= self.config.failure_threshold:
            ...
            logger.warning(
                f"Circuit breaker {self.name} transitioning to OPEN after {self.metrics.failure_count} failures"
            )
    ...
    async def check_readiness(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                overall_status = (
                    "degraded"  # External API failure is not critical
                )
    ...
    async def check_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": readiness[
                    "status"
                ],  # Use readiness as overall status
                "timestamp": datetime.utcnow().isoformat(),
                "liveness": liveness,
                "readiness": readiness,
                "circuit_breakers": {
